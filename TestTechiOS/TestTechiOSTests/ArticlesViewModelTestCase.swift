//
//  ArticlesViewModelTestCase.swift
//  TestTechiOSTests
//
//  Created by DIAN on 14/11/2021.
//
...
class ArticlesViewModelTestCase: XCTestCase {
    ...
    let secondArticle: Article = Article(
        id:1077103477,
        categoryId:2,
    ...
    let thirdArticle: Article = Article(
        id:1701863873,
        categoryId:3,
        title:"Radiateurs",
    ...
    let fourthArticle: Article = Article(
        id:1701863234,
        categoryId:2,
    ...
    func testUpdateWithFilter() throws {
        ...
        XCTAssert(articlesViewModel.articlesFilter == [
            secondArticle, fourthArticle
        ])
    }
    
    func testOrderByDateAndUrgency() throws {
        let articlesList = [firstArticle, secondArticle, thirdArticle, fourthArticle]
        
        let resultList = articlesViewModel.orderByUrgency(articlesViewModel.orderByDate(articlesList))
        
        XCTAssert(resultList == [secondArticle, fourthArticle, thirdArticle, firstArticle])
    }
}
